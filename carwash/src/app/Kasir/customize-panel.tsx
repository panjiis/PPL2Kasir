...
//   const [activeTab, setActiveTab] = useState<"theme" | "buttons" | "products" | "profile">("theme")
...
//   const sections = {
//     "Aside Pills": Object.keys(buttonPrefs).filter((k) => k.startsWith("aside:pill:")),
//     "Aside Bills": Object.keys(buttonPrefs).filter((k) => k.startsWith("aside:bill:")),
//     "Center Pills": Object.keys(buttonPrefs).filter((k) => k.startsWith("center:pill:")),
//     "Center Tiles": Object.keys(buttonPrefs).filter((k) => k.startsWith("center:tile:")),
...
//           <h2 className="text-xl font-rubik font-bold text-foreground">Customization Settings</h2>
//           <button
...
//                 <h3 className="font-rubik font-semibold text-foreground text-sm">Global Background Color</h3>
...
//                         opt.classes.bg,
//                         globalBackgroundColor === opt.key ? "ring-2 ring-offset-2 ring-primary" : "border-border",
//                       ].join(" ")}
//                       title={opt.key}
//                       aria-pressed={globalBackgroundColor === opt.key}
//                     />
//                   ))}
//                 </div>
//               </div>
...
//               <div className="space-y-2">
//                 <h3 className="font-rubik font-semibold text-foreground text-sm">Global Button Color</h3>
//                 <div className="flex flex-wrap gap-2">
//                   {colorOptions.map((opt) => (
//                     <button
//                       key={opt.key}
...
//                         "h-9 w-9 rounded border-2",
//                         opt.classes.bg,
//                         globalButtonColor === opt.key ? "ring-2 ring-offset-2 ring-primary" : "border-border",
//                       ].join(" ")}
//                       title={opt.key}
//                       aria-pressed={globalButtonColor === opt.key}
//                     />
//                   ))}
//                 </div>
//               </div>
...
//                         const defaultLabel = key.split(":").pop()?.replace(/-/g, " ") || ""
//                         return (
//                           <div
//                             key={key}
...
//                           >
//                             <div className="space-y-2">
//                               <label className="text-xs text-muted-foreground block">{key}</label>
//                               <input
//                                 type="text"
...
//                                     opt.classes.bg,
//                                     pref?.color === opt.key ? "ring-2 ring-offset-2 ring-primary" : "border-border",
//                                   ].join(" ")}
//                                   title={opt.key}
//                                 />
//                               ))}
...
//                 Customize product images by entering image URLs below. Leave blank to use defaults.
//               </p>
//               {Object.entries(productImages).map(([productId, imageUrl]) => (
//                 <div key={productId} className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50">
//                   <Image
...
//                     <label className="text-xs text-muted-foreground block mb-1">{productId}</label>
//                     <input
//                       type="text"
//                       className="w-full rounded-md border border-border bg-card text-foreground text-sm px-3 py-2"
//                       defaultValue={imageUrl}
//                       onBlur={(e) => setProductImage(productId, e.currentTarget.value)}
...
//                   <Image
//                     src={userProfile.photo || "/placeholder.svg?height=64&width=64"}
