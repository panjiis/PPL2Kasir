...
export function CustomizationPanel() {
  ...
  const [activeTab, setActiveTab] = useState<"buttons" | "products" | "profile">("buttons")
            ...
            <div className="space-y-4 max-w-md">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    onBlur={(e) => setUserProfile({ ...userProfile, photo: e.currentTarget.value })}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onBlur={(e) => setUserProfile({ ...userProfile, name: e.currentTarget.value })}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onBlur={(e) => setUserProfile({ ...userProfile, role: e.currentTarget.value })}
