...
import type { ProductItem, ProductType } from './dummy';
...
// ✅ helper: aman tanpa any, fix parameter type
...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  // ✅ addItem tanpa useCallback biar clean & bebas warning
  const addItem = safeAddItem(locked, (p: ProductItem) => {
    setItems((prev) => {
